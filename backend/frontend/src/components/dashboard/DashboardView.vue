                ...
                <div class="col-lg-4 col-md-4 order-1">
                  <div class="row">
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body" v-for="category in allCategories" :key="category.id">
                          ...
                          <span class="fw-semibold d-block mb-1">{{ category.name }}</span>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h3 class="card-title text-nowrap mb-1">{{ allProductCount }}</h3>
